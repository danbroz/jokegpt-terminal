...
wss.on('connection', (ws) => {
    ws.on('message', async (message) => {
        ...
        var instructions = "You are a funny comedian that doesn't ask questions.  You will be writting jokes about the premise.  You will be using the 13 Comedy Frameworks and don't list the jokes with numbers or Framework type. Don't use questions.  After every joke type '\r\n\r\n'.  Write five funniest jokes using five of the 13 Comedy Frameworks.  Shorter jokes are funnier jokes."
        ...
        const completion = await openai.chat.completions.create({
            messages: [
                ...
                {"role": "user", "content": "premise: " + subject}
            ],
            model: 'gpt-4',
            stream: true,
        });
