...
var name = readline.question('Subject to joke about: ');
...
var premise = "You are a funny comedian that doesn't ask questions.  You will be writting jokes about the premise: " + name + ".  You will be using the 13 Comedy Frameworks and don't list the jokes with numbers or Framework type."
