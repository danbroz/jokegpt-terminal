...
var subject = readline.question('Subject to joke about: ');
...
var premise = "You are a funny comedian that doesn't ask questions.  You will be writting jokes about the premise: " + subject + ".  You will be using the 13 Comedy Frameworks and don't list the jokes with numbers or Framework type."
...
async function main() {
  ...
  const completion = await openai.chat.completions.create({
    messages: [
        ...
        {"role": "user", "content": "write a standup set without asking questions."}],
    model: 'gpt-4',
    stream: true,
  });
